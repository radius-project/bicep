...
{
    public class ComponentDeclarationSyntax : SyntaxBase, INamedDeclarationSyntax
    {
        public ComponentDeclarationSyntax(Token keyword, IdentifierSyntax name, SyntaxBase type, SyntaxBase assignment, SyntaxBase? ifCondition, SyntaxBase body)
        {
        ...
        public TypeSymbol GetDeclaredType(IComponentTypeProvider componentTypeProvider)
        {
            ...
            return componentTypeProvider.GetComponentType(typeReference);
        }
    }
}