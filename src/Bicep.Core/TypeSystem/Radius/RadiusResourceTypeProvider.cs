...
namespace Bicep.Core.TypeSystem.Radius
{
    public class RadiusResourceTypeProvider : IResourceTypeProvider
    {
        ...
        private static readonly Regex listWildcardFunctionRegex = new Regex("^list[a-zA-Z]*$", RegexOptions.Compiled | RegexOptions.CultureInvariant);
        ...
        private static IEnumerable<FunctionOverload> GetBicepMethods(ResourceTypeReference resourceType)
        {
            ...
            yield return new FunctionWildcardOverloadBuilder("list*", listWildcardFunctionRegex)
