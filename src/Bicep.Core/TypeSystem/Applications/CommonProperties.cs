...
namespace Bicep.Core.TypeSystem.Applications
{
    internal static class CommonProperties
    {
        ...
        public static readonly TypeProperty Type = new TypeProperty("type", new StringLiteralType(ApplicationResourceTypes.Component.ResourceType.FullyQualifiedType), TypePropertyFlags.ReadOnly | TypePropertyFlags.DeployTimeConstant);

        public static readonly TypeProperty ApiVersion = new TypeProperty("apiVersion", new StringLiteralType(ApplicationResourceTypes.Component.ResourceType.ApiVersion), TypePropertyFlags.ReadOnly | TypePropertyFlags.DeployTimeConstant);
