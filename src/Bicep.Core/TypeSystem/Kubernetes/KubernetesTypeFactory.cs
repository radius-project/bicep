...
namespace Bicep.Core.TypeSystem.Kubernetes
{
    public class KubernetesResourceTypeFactory
    {
        ...
        public KubernetesResourceTypeFactory()
        {
            typeCache = new ConcurrentDictionary<Azure.Bicep.Types.Concrete.TypeBase, TypeSymbol>();
        }
        ...
        public ResourceTypeComponents GetResourceType(Azure.Bicep.Types.Concrete.ResourceType resourceType)
        {
            ...
            var bodyType = GetTypeSymbol(resourceType.Body.Type, isResourceBodyType: true);
        ...
        private ITypeReference GetTypeReference(Azure.Bicep.Types.Concrete.ITypeReference input)
            => new DeferredTypeReference(() => GetTypeSymbol(input.Type, isResourceBodyType: false));
