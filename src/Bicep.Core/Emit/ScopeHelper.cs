...
namespace Bicep.Core.Emit
{
    public static class ScopeHelper
    {
        ...
        public static ImmutableDictionary<DeclaredResourceMetadata, ScopeData> GetResourceScopeInfo(SemanticModel semanticModel, IDiagnosticWriter diagnosticWriter)
        {
            ...
            var ancestorsLookup = semanticModel.AllResources.OfType<DeclaredResourceMetadata>()
                .ToDictionary(
                    x => x,
            ...
            foreach (var resourceToValidate in semanticModel.AllResources.OfType<DeclaredResourceMetadata>())
            {
