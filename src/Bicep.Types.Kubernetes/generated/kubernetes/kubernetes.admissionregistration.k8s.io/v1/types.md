# kubernetes.admissionregistration.k8s.io @ v1

## Resource kubernetes.admissionregistration.k8s.io/MutatingWebhookConfiguration@v1
...
## Resource kubernetes.admissionregistration.k8s.io/ValidatingWebhookConfiguration@v1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'admissionregistration.k8s.io/v1' (ReadOnly, DeployTimeConstant): The api version.
