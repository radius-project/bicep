# kubernetes.rbac.authorization.k8s.io @ v1beta1

## Resource kubernetes.rbac.authorization.k8s.io/ClusterRole@v1beta1
...
## Resource kubernetes.rbac.authorization.k8s.io/ClusterRoleBinding@v1beta1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'rbac.authorization.k8s.io/v1beta1' (ReadOnly, DeployTimeConstant): The api version.
...
## Resource kubernetes.rbac.authorization.k8s.io/Role@v1beta1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'rbac.authorization.k8s.io/v1beta1' (ReadOnly, DeployTimeConstant): The api version.
...
## Resource kubernetes.rbac.authorization.k8s.io/RoleBinding@v1beta1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'rbac.authorization.k8s.io/v1beta1' (ReadOnly, DeployTimeConstant): The api version.
