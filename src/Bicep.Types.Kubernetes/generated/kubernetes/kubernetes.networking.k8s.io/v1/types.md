...
## Resource kubernetes.networking.k8s.io/Ingress@v1
...
## Resource kubernetes.networking.k8s.io/IngressClass@v1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'networking.k8s.io/v1' (ReadOnly, DeployTimeConstant): The api version.
...
## Resource kubernetes.networking.k8s.io/NetworkPolicy@v1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'networking.k8s.io/v1' (ReadOnly, DeployTimeConstant): The api version.
