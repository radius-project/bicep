...
## Resource kubernetes.storage.k8s.io/CSIDriver@v1
...
## Resource kubernetes.storage.k8s.io/CSINode@v1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'storage.k8s.io/v1' (ReadOnly, DeployTimeConstant): The api version.
...
## Resource kubernetes.storage.k8s.io/StorageClass@v1
* **Valid Scope(s)**: Unknown
### Properties
...
## Resource kubernetes.storage.k8s.io/VolumeAttachment@v1
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: 'storage.k8s.io/v1' (ReadOnly, DeployTimeConstant): The api version.
