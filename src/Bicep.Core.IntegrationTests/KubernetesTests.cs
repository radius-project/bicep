...
";
            ...
            var configMapSymbol = model.AllResources.OfType<DeclaredResourceMetadata>().Should().ContainSingle(r => r.Symbol.Name == "map").Subject.Symbol;
...
";
            ...
            var secretSymbol = model.AllResources.OfType<DeclaredResourceMetadata>().Should().ContainSingle(r => r.Symbol.Name == "secret").Subject.Symbol;
